...
// DEFINEOPTION( DSTBNDF, int, 2, value>=0 && value<=5 )
// DEFINEOPTION( DSTNMAX, int, 100, value>5 && value<=MAX_VALUE_FOR_DSTNMAX)
DEFINEOPTION( DSTSEGM, int, 6, value>=1 && value<=20 )
DEFINEOPTION( DSTNPOS, int, 12, value>=1 && value<=20 )
DEFINEOPTION( DSTSEP6, float, 12.f, value>=1.f && value<=64.f )
DEFINEOPTION( DSTGAPL, float, 24.f, value>=1.f && value<=255.f )
DEFINEOPTION( DSTFREE, int, 3, value>=1 && value<=20 )

// Context vector clustering options:
...
DEFINEOPTION( DDMSWGT, float, 0.1f, value>=0.0f && value<1.0f )
