...
enum TPSVectorConsts { 
        ...
        ptr2DNoDstsPerPos = MAX_N_IR_DISTANCE_VALUES_PLUS_LENGTH
};
...
// max number of profiles processed in parallel is unlikely currently (on both CPU and GPU)
        ...
        //
        pmv2DDDvalues = pmv2DCVnorm2 + 1,//IR distance values; [*OPTIONAL*];
        //
        pmv2DSSsprbs = pmv2DDDvalues+ ptr2DNoDstsPerPos,//SS state probabilities; pmv2DNoSSSps entries; [*OPTIONAL*]
