...
// #if !defined( COTHER_INSTALL_DIR )
// #   error   "Unable to compile: Undefined installation directory (COTHER_INSTALL_DIR)."
// #endif

#if !defined( COTHERSTATEDIR )
#   error   "Unable to compile: Undefined configuration directory (COTHERSTATEDIR)."
#endif

#define VARDIR var
#define PARAM_DIRNAME  COTHERSTATEDIR

#define PARAM_FILENAME cother.par
